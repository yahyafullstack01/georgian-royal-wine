...
const translations = {
  en: {
    ...
    home: {
      ...
      shippingDesc:
        "Order one box or more and delivery is free.",
    ...
    shop: {
      ...
      loading: "Loading...",
      deliveryNote: "Free delivery in Torrevieja · 1 box or more — free delivery",
    },
    contact: {
      title: "Contact Us",
      intro:
    ...
    cart: {
      ...
      deliveryTorrevieja: "Free delivery in Torrevieja",
  ...
  es: {
    ...
    home: {
      ...
      shippingDesc: "Compre una caja o más y la entrega es gratuita.",
    ...
    shop: {
      ...
      loading: "Cargando...",
      deliveryNote: "Entrega gratuita en Torrevieja · 1 caja o más — entrega gratuita",
    },
    contact: {
      title: "Contáctenos",
      intro:
    ...
    cart: {
      ...
      deliveryTorrevieja: "Entrega gratuita en Torrevieja",
  ...
  ru: {
    ...
    home: {
      ...
      shippingDesc: "При заказе от 1 коробки доставка бесплатная.",
    ...
    shop: {
      ...
      loading: "Загрузка...",
      deliveryNote: "Бесплатная доставка в Торревьехе · от 1 коробки — доставка бесплатная",
    },
    contact: {
    ...
    cart: {
      ...
      deliveryTorrevieja: "Доставка по г. Торревьеха бесплатная",
  ...
  fr: {
    ...
    home: {
      ...
      shippingDesc: "Commandez une caisse ou plus : livraison offerte.",
    ...
    shop: {
      ...
      loading: "Chargement...",
      deliveryNote: "Livraison gratuite à Torrevieja · 1 caisse ou plus — livraison gratuite",
    },
    contact: {
    ...
    cart: {
      ...
      deliveryTorrevieja: "Livraison gratuite à Torrevieja",
  ...
  uk: {
    ...
    home: {
      ...
      shippingDesc: "При замовленні від 1 коробки доставка безкоштовна.",
    ...
    shop: {
      ...
      deliveryNote: "Безкоштовна доставка в Торрев'єсі · від 1 коробки — доставка безкоштовна",
    },
    contact: {
    ...
    cart: {
      ...
      deliveryTorrevieja: "Доставка по м. Торрев'єха безкоштовна",
